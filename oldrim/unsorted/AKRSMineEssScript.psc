Scriptname AKRSMineEssScript extends ObjectReference  
;
...
;	ResourceCountTotal = game.getplayer().getav("Smithing") as int
;	if ResourceCountTotal < 10
;		resourcecount == 1
;	elseif ResourceCountTotal < 20
;		resourcecount == 2
;	elseif ResourceCountTotal < 30
;		resourcecount == 3
;	elseif ResourceCountTotal < 40
;		resourcecount == 4
;	elseif ResourceCountTotal < 50
;		resourcecount == 5
;	elseif ResourceCountTotal < 60
;		resourcecount == 10
;;	elseif ResourceCountTotal < 80
;		resourcecount == 20
;	elseif ResourceCountTotal <= 100
;		resourcecount == 25
;	elseif ResourceCountTotal > 100
;		resourcecount == 40
;;	endif
...
function giveOre()
	...
	if ResourceCountCurrent > 0
		ResourceCountCurrent = (ResourceCountCurrent - ResourceCount)

Scriptname AKPresurePlateConst extends TrapTriggerBase  
; A modified copy of PresurePlate Script. 
;This version requires the actor to remain on the pressure plate to keep the door/trap etc open
;
;
;================================================================
